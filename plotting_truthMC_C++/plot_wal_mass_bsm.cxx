...
TH1F * h_10 = (TH1F*)f0->Get("mass_bsm");
//TH1F * h_20 = (TH1F*)f1->Get("mass_bsm");
//TH1F * h_30 = (TH1F*)f2->Get("mass_bsm");
//TH1F * h_40 = (TH1F*)f3->Get("n_ele");
//TH1F * h_60 = (TH1F*)f4->Get("n_ele");
//TH1F * h_80 = (TH1F*)f5->Get("n_ele");


        h_10->GetXaxis()->SetTitle("mass_{'H+'}");
        h_10->GetYaxis()->SetTitle("a.u.");   
        //h_10->GetXaxis()->SetRangeUser(0,170);
		...
		leg->AddEntry(h_10,"m_{H+} = 130 GeV","l");
