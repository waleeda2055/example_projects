...
TCanvas* c1 = new TCanvas("c1","c1",800,600);
    c1->cd();
    SetAtlasStyle();
    TFile *f0 = TFile::Open("/homes/chachapoya/waleeda/Documents/Higgs/scp/aug2/run4/hist-Hplus_aug2.root");
    TFile *f1 = TFile::Open("/Users/shreya/h1_h3_rootfiles/hist-ttbar_h3_20_ljets.root");
    TFile *f2 = TFile::Open("/Users/shreya/h1_h3_rootfiles/hist-ttbar_h1_60_ljets.root");
...
TH1F * h_10 = (TH1F*)f0->Get("n_ele");
TH1F * h_20 = (TH1F*)f1->Get("n_ele");
TH1F * h_30 = (TH1F*)f2->Get("n_ele");
TH1F * h_40 = (TH1F*)f3->Get("n_ele");
TH1F * h_60 = (TH1F*)f4->Get("n_ele");
TH1F * h_80 = (TH1F*)f5->Get("n_ele");


        h_10->GetXaxis()->SetTitle("no. of electrons");
        h_10->GetYaxis()->SetTitle("a.u.");   
         h_10->GetXaxis()->SetRangeUser(0,200);
		...
		leg->AddEntry(h_10,"m_{a} = 20 GeV, h1_odd","l");
		leg->AddEntry(h_20,"m_{a} = 20 GeV, h3_odd","l");
		leg->AddEntry(h_30,"m_{a} = 60 GeV, h1_odd","l");
