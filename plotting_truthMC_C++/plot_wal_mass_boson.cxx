...
TH1F * h_10 = (TH1F*)f0->Get("mass_boson");
TH1F * h_20 = (TH1F*)f1->Get("mass_boson");
TH1F * h_30 = (TH1F*)f2->Get("mass_boson");
//TH1F * h_40 = (TH1F*)f3->Get("n_ele");
//TH1F * h_60 = (TH1F*)f4->Get("n_ele");
//TH1F * h_80 = (TH1F*)f5->Get("n_ele");


        h_10->GetXaxis()->SetTitle("mass_{a1}");
        h_10->GetYaxis()->SetTitle("a.u.");   
        h_10->GetXaxis()->SetRangeUser(7,11);
		...
		TLegend *leg = new TLegend(0.75,0.6,.90,0.75);
		leg->SetFillStyle(0);
		leg->SetBorderSize(0);
		...
		leg->Draw();
	        ...
	        ATLASLabel(0.58,0.8,"Sim. Internal");
